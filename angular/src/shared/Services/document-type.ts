...
@Injectable({
  ...
  export class DocumentTypeService
  {
   ...
   // return this.http.post(this.REST_API_SERVER + '/api/services/app/PurchaseOrderService/CreatePurchaseOrder',content_)
     ...
     createMSWD(body: MappingStandardDocumentModel | undefined) : Observable<any> {
    ...
    let options = { headers: headers };
    // return this.http.post(this.REST_API_SERVER + '/api/services/app/PurchaseOrderService/CreatePurchaseOrder',content_)
        return this.http.post<any>(`${environment.apiUrl}/api/DocumentType/createMSWD`,content_,options)
      }

      GetMSWD(value): Observable<any> {
        ...
        let options = { headers: headers };
        return this.http.post<any>(`${environment.apiUrl}/api/DocumentType/GetMSWD`, value, options);
      ...
      DeleteMSWD(id) {
        ...
        return this.http.post<any>(`${environment.apiUrl}/api/DocumentType/DelMSWD?id=${id}`,options)
