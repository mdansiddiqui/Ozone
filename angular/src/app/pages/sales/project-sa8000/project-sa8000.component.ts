...
export class ProjectSA8000Component implements OnInit {
  ...
  onSubmitChangeRequest() {
      ...
      SA8000ChangeRequest(): void {
        ...
        Object.keys(this.SAClientChangeRequest.controls).forEach(key => {
          ...
          if (this.SAClientChangeRequest.controls[key].value != null && this.SAClientChangeRequest.controls[key].value != "" && this.SAClientChangeRequest.controls[key].value != undefined && this.SAClientChangeRequest.controls[key].value != isNaN) {
            var sname = key;
  ...
  contractApproved(): void {
    ...
    if (this.SAForm.get('ContractStatusId').value == null || this.SAForm.get('ContractStatusId').value == undefined || this.SAForm.get('ContractStatusId').value == "" || this.SAForm.get('ContractStatusId').value == '' || this.SAForm.get('ContractStatusId').value == isNaN) {
  ...
  UpdateProject() {
    ...
    this.ContarctFileName=ClientProjectMod.contractFilePath;
      ...
      if (data.clientSitesModel != null && data.clientSitesModel != "" && data.clientSitesModel != '' && data.clientSitesModel != undefined && data.clientSitesModel != isNaN) {
     ...
     // this.SAForm.controls.ProjectTypeId.setValue(ClientProjectMod.projectTypeId);
      ...
      this.SAForm.controls.DurationSurvVisit.setValue(ProjectSaData.durationSurvVisit);
      ...
      if (this.AuditId != null && this.AuditId != undefined && this.AuditId > 0) {
        this.btnApproval = false;
        this.btnContractSave = false;
        this.savebtn = false;
        this.IsContract = false;
  ...
  onSubmit1(): void {
    ...
    if (this.ProjectId > 0) {
      ...
      if (this.fileToUpload != null && this.fileToUpload != "" && this.fileToUpload != undefined && this.fileToUpload != undefined && this.fileToUpload != isNaN) {
    ...
    Object.keys(this.SAForm.controls).forEach(key => {
      ...
      if (this.SAForm.controls[key].value != null && this.SAForm.controls[key].value != "" && this.SAForm.controls[key].value != undefined && this.SAForm.controls[key].value != isNaN) {
        var sname = key;
        //var sname= this.SAForm.controls[key].;
  ...
  OnApprovalSubmit(): void {
    ...
    if (this.SAForm.get('ApprovalStatusId').value > 0 && this.SAForm.get('Remarks').value != null && this.SAForm.get('Remarks').value != '' && this.SAForm.get('Remarks').value != undefined && this.SAForm.get('Remarks').value != "" && this.SAForm.get('Remarks').value != isNaN) {
      ...
      abp.message.error("Approval Status and Remarks can not be Empty", "Alert")
    }
  }
  ...
  onContractSubmit(): void {
    ...
    try {
      ...
      //if (fileName == this.ProjectCode) {
        ...
        if (this.fileToUpload == null || this.fileToUpload == undefined || this.fileToUpload == "" || this.fileToUpload == '' || this.fileToUpload == isNaN) {
