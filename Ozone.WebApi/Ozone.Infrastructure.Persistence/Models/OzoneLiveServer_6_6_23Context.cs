...
{
    public partial class OzoneLiveServer_6_6_23Context : DbContext
    {
        public OzoneLiveServer_6_6_23Context()
        {
        }

        public OzoneLiveServer_6_6_23Context(DbContextOptions<OzoneLiveServer_6_6_23Context> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<ActivityLogRemarksHistory> ActivityLogRemarksHistory { get; set; }
...
//                optionsBuilder.UseSqlServer("Data Source=DESKTOP-PE36NEL;Initial Catalog=OzoneLiveServer_6_6_23;user id=sa;password=123qwe;integrated security=True;");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ActivityLogRemarksHistory>(entity =>
            {
                entity.HasOne(d => d.ActivityLog)
                    ...
                    .HasConstraintName("FK_ActivityLogRemarksHistory_ActivityLog");

                entity.HasOne(d => d.ApprovalStatus)
                    .WithMany(p => p.ActivityLogRemarksHistory)
                    .HasForeignKey(d => d.ApprovalStatusId)
                    .HasConstraintName("FK_ActivityLogRemarksHistory_ApprovalStatus");

                entity.HasOne(d => d.RemarksBy)
                    .WithMany(p => p.ActivityLogRemarksHistory)
                    .HasForeignKey(d => d.RemarksById)
                    .HasConstraintName("FK_ActivityLogRemarksHistory_SecUser");
            });
            ...
            modelBuilder.Entity<AuditReportHistory>(entity =>
            {
                ...
                entity.HasOne(d => d.ClientAuditVisit)
                    ...
                    .HasConstraintName("FK_AuditReportHistory_ClientAuditVisit");
            ...
            modelBuilder.Entity<ClientProjects>(entity =>
            {
                ...
                entity.HasOne(d => d.Consultant)
                    ...
                    .HasConstraintName("FK_ClientProjects_Consultant");
                ...
                entity.HasOne(d => d.SurveillanceVisitFrequency)
                    ...
                    .HasConstraintName("FK_ClientProjects_SurveillanceVisitFrequency");
            ...
            modelBuilder.Entity<FileUploading>(entity =>
            {
                entity.HasOne(d => d.Agency)
                    .WithMany(p => p.FileUploading)
                    .HasForeignKey(d => d.AgencyId)
                    .HasConstraintName("FK_FileUploading_Organization");

                entity.HasOne(d => d.CreatedBy)
                    .WithMany(p => p.FileUploadingCreatedBy)
                    .HasForeignKey(d => d.CreatedById)
                    .HasConstraintName("FK_FileUploading_SecUser2");

                entity.HasOne(d => d.FromUser)
                    .WithMany(p => p.FileUploadingFromUser)
                    .HasForeignKey(d => d.FromUserId)
                    .HasConstraintName("FK_FileUploading_SecUser");
            ...
            modelBuilder.Entity<QcHistory>(entity =>
            {
                ...
                entity.HasOne(d => d.QcStatus)
                    ...
                    .HasConstraintName("FK_QcHistory_QcStatus");
            ...
            modelBuilder.Entity<SecUser>(entity =>
            {
                entity.HasOne(d => d.ApprovelStatus)
                    ...
                    .HasConstraintName("FK__SecUser__Approve__2AA05119");
                ...
                entity.HasOne(d => d.TypeOfEnrollment)
                    .WithMany(p => p.SecUser)
                    .HasForeignKey(d => d.TypeOfEnrollmentId)
                    .HasConstraintName("FK_SecUser_TypeOfEnrollment");
