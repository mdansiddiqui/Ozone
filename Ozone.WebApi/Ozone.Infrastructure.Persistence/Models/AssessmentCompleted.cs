...
{
    public partial class AssessmentCompleted
    {
        public AssessmentCompleted()
        {
        ...
        [InverseProperty(nameof(SecUser.AssessmentCompletedCreatedBy))]
        public virtual SecUser CreatedBy { get; set; }
        [ForeignKey(nameof(LastModifiedById))]
        [InverseProperty(nameof(SecUser.AssessmentCompletedLastModifiedBy))]
        public virtual SecUser LastModifiedBy { get; set; }
        [InverseProperty("AssessmentCompleted")]
