...
export class SlcpComponent implements OnInit {
 ...
 public ClientSiteData:any;
  ...
  ContractfileToUploadSlcp: any;
  fileToUploadSLCP: any;
  ...
  editSLCPProject() {
      ...
      this._SlcpService.GetProjectSLCPBYId(this.ProjectId).subscribe(data => {
        ...
        this.SLCPFormControl.controls.RequestOfSiteId.setValue(ProjectSaData.requestOfSiteId);

        let req = new Date(this.datePipe.transform(ProjectSaData.tentativeDate, 'yyyy/MM/dd'))
        this.SLCPFormControl.controls.TentativeDate.setValue(this.datePipe.transform(req, 'yyyy-MM-dd'))

      })
  }


  handlefileInputSLCP(e: any){
    this.fileToUploadSLCP = <File>e?.target?.files[0];
  }
  ...
  onSubmitChangeRequest() {
        ...
        if (this.SLCPFormControl.invalid) {
          return;
        }
      ...
      SLCPChangeRequest(): void {
        ...
        Object.keys(this.SLCPFormControl.controls).forEach(key => {
          ...
          if (this.SLCPFormControl.controls[key].value != null && this.SLCPFormControl.controls[key].value != "" && this.SLCPFormControl.controls[key].value != undefined && this.SLCPFormControl.controls[key].value != isNaN) {
            var sname = key;
...
handleContractfileInputSlcp(e:any){
  this.ContractfileToUploadSlcp = <File>e?.target?.files[0];
}
...
//          console.log(this.ModuleVersionList);
