...
export class DashboardComponent implements OnInit {
  ...
  constructor(
    ...
    this.ProjectRemarksHistoryPopup =
      this.ProjectRemarksHistoryPopup.bind(this);
    this.ClientSitesRemarksHistoryPopup =
      this.ClientSitesRemarksHistoryPopup.bind(this);
    ...
    this.ProjectChangeRequestDownloadfile =
      this.ProjectChangeRequestDownloadfile.bind(this);
  ...
  ngOnInit(): void {
    ...
    // this.pageSize=3;
    this.pagedDto.organizationId = parseInt(
  ...
  review1(e) {
    ...
    this.router.navigateByUrl(
      "/app/pages/sales/audit-plan?ProjectId=" +
        e.row.data.projectId +
        "&StandardId=" +
        e.row.data.standardId +
        "&ClientId=" +
        e.row.data.clientId +
        "&AuditVisitId=" +
        e.row.data.id
  ...
  onpopup(e) {
    ...
    this.CurrentName =
      name + "   " + "( " + e.row.data.approvalStatusName + " )";
    ...
    if (
      parseInt(localStorage.getItem("organizationId")) == 1 &&
      (parseInt(e.row.data.approvalStatusId) == 2 ||
        parseInt(e.row.data.approvalStatusId) == 3)
    ) {
      this.RecordeviewClient = false;
      this.editClientrecord = false;
    } else if (
      parseInt(localStorage.getItem("organizationId")) > 1 &&
      (parseInt(e.row.data.approvalStatusId) == 1 ||
        parseInt(e.row.data.approvalStatusId) == 2 ||
        parseInt(e.row.data.approvalStatusId) == 10002)
    ) {
      this.RecordeviewClient = false;
      this.editClientrecord = false;
    } else {
    ...
    this._DashboardService
      .GetClientChangeDataById(parseInt(e.row.data.id), this.pagedDto)
      .subscribe((Response) => {
  ...
  Projectonpopup(e) {
    ...
    this._DashboardService
      .GetProjectChangeDataById(parseInt(e.row.data.id), this.pagedDto)
      .subscribe((Response) => {
        let count = Response.filter(
          (item) => item.affectedColumns != "ContractFilePath"
        ).length;
        let countfile = Response.filter(
          (item) => item.affectedColumns == "ContractFilePath"
        ).length;
        ...
        if (countfile > 0) {
          ...
          this.ProjectChangeRequestFileUploadlist = Response.filter(
            (item) => item.affectedColumns == "ContractFilePath"
          );
        } else {
        ...
        if (count > 0) {
          ...
          this.ProjectChangeRequestStatuslist = Response.filter(
            (item) => item.affectedColumns != "ContractFilePath"
          );
        } else {
  ...
  RemarksPopup(e) {
    ...
    this._DashboardService
      .GetClientChangeRemarksDataById(e.row.data.id)
      .subscribe((Response) => {
  ...
  ProjectRemarksHistoryPopup(e) {
    ...
    this._DashboardService
      .GetProjectSA8000RemarksDataById(e.row.data.id)
      .subscribe((Response) => {
  ...
  ClientSitesRemarksHistoryPopup(e) {
    ...
    this._DashboardService
      .GetClientSitesChangeRemarksDataById(e.row.data.id)
      .subscribe((Response) => {
  ...
  loadModuleVersion(): void {
    this._SlcpService
      .GetALLModuleVersion(this.standardId)
      .subscribe((Response) => {
        this.NewValuesList = Response;
      });
  }
  ...
  NewValuesEditSubmit() {
    if (
      ...
      this._DashboardService
        .ApprovedClientChange(ClientSitesModel)
        .subscribe((Response) => {
          abp.message.info(Response.message);
          if (Response.message == "Successfully Submited..") {
            this.clientChangeDataList = this.clientChangeDataList.filter(
              (element) => element.id !== ActivitylogId
            );
          }
          this.editdisplay = "none";
          this.displayStyle = "block";
      ...
      abp.message.error("New Values and Remarks can not be Empty", "Alert");
    }
  }
  ...
  ResubmitProjectRequest() {
    ...
    if (
      ...
      let ActivitylogId = parseInt(
        this.ProjectRemarks.get("ActivityLogId").value
      );

      this._DashboardService
        .ApprovedProjectChange(projectSitesModel)
        .subscribe((Response) => {
          abp.message.info(Response.message);
          if (
            ...
            this.ProjectChangeRequestStatuslist =
              this.ProjectChangeRequestStatuslist.filter(
                (element) => element.id !== ActivitylogId
              );
          }
          this.editProjectdisplay = "none";
      ...
      abp.message.error("New Value And Remarks can not be Empty", "Alert");
    }
  }
  ...
  ResubmitClientSitesRequest() {
    if (
      ...
      this._DashboardService
        .ApprovedClientSitesChange(clientSitesResubmitModel)
        .subscribe((Response) => {
          abp.message.info(Response.message);
          this.editClientSitesdisplay = "none";
          // this.editProjectdisplay="block"
      ...
      abp.message.error("Input Field And Remarks can not be Empty", "Alert");
    }
  }
  ...
  ProjectChangeRequestDownloadfile(e): void {
    ...
    this._DashboardService
      .ProjectChangeRequestDownloadfile(this.id)
      .subscribe((result: Blob) => {
        const Blb = new Blob([result], { type: result.type });
  ...
  ClientSitesDownloadfile(e): void {
    ...
    this._DashboardService
      .ClientSitesdownloadFile(this.id)
      .subscribe((result: Blob) => {
        const Blb = new Blob([result], { type: result.type });
  ...
  OnClientSitesApprovalSubmit(): void {
    if (
      ...
      let ActivitylogId = parseInt(
        this.ClientSitesRemarks.get("ActivityLogId").value
      );
      this._DashboardService
        .ApprovedClientSitesChange(clientSitesModel)
        .subscribe((Response) => {
          abp.message.info(Response.message);
          ...
          if (
            ...
            this.ClientSitesChangeRequestStatuslist =
              this.ClientSitesChangeRequestStatuslist.filter(
                (element) => element.id !== ActivitylogId
              );
          }
          this.ClientSitesRemarksdisplay = "none";
  ...
  review(e) {
    this._ClientService
      .GetProjectFormUrlById(e.row.data.standardId)
      .subscribe((Response) => {
  ...
  ProjectchangeRequestRows(e) {
    ...
    this.totalCount = 0;
    this._DashboardService
      .GetAllProjectChangeRequest(e.data.id, this.pagedDto)
      .subscribe((Response) => {
  ...
  ClientSitesMainPopup(e) {
    ...
    this._DashboardService
      .GetClientSitesChangeDataById(parseInt(e.row.data.id), this.pagedDto)
      .subscribe((Response) => {
  ...
  ClientSiteschangeRequestRows(e) {
    ...
    this.totalCount = 0;
    this._DashboardService
      .GetAllClientSitesChangeRequest(e.data.id, this.pagedDto)
      .subscribe((Response) => {
  ...
  ClientChangeRowClick(e) {
    ...
    this.totalCount = 0;
    this._DashboardService
      .GetAllClientChange(e.data.id, this.pagedDto)
      .subscribe((Response) => {
  ...
  projectListData(PId: number) {
    ...
    if(PId>0){
      //alert("Dashboard 1538" + PId);

    this._DashboardService
      .GetAllProjects(PId, this.pagedDto)
      .subscribe((Response) => {
  ...
  onRowContractClick(e) {
    ...
    this.CurrentName = name + "   " + "( " + e.data.name + " )";
    console.log(e.data.id);
    //alert("Dashboard 1575" + e.data.id);
    this.pagedDto.organizationId = parseInt(
      localStorage.getItem("organizationId")
    );
    this.totalCount = 0;
    this._DashboardService
      .GetAllProjects(e.data.id, this.pagedDto)
      .subscribe((Response) => {
        this.totalCount = Response.totalCount;
  ...
  onRowClick1(e) {
    ...
    this.totalCount = 0;
    this._DashboardService
      .GetAllAudits(e.data.id, this.pagedDto)
      .subscribe((Response) => {
        this.totalCount = Response.totalCount;
  ...
  UpdateProject() {
    ...
    this._DashboardService
      .GetDashboardData(roleId, this.pagedDto)
      .subscribe((data) => {
        console.log("service");
        ...
        this.ProjectChangeRequestStatus =
          data.projectRequestDashboardStatusModel;
        this.ClientSiteChangeRequestStatus =
          data.clientSitetRequestDashboardStatusModel;
        ...
        this.Recertification_Windowperiod_start_Surv_2 =
          data.recertification_Windowperiod_start_Surv_2;
  ...
  loadSecRoleForm() {
    ...
    this._makerAuthorizerFormService.getSecRoleForm().subscribe((data) => {
      ...
      this.secRoleForm = data.find(
        (x) => x.formCode != null && x.formCode == this.formName
      );
  ...
  OnManageVisit(e) {
    this.router.navigateByUrl(
      "/app/pages/sales/client-add-visit?" +
        "ProjectId=" +
        e.row.data.id +
        "&StandardId=" +
        e.row.data.standardId
  ...
  ManageAuditVisit(e) {
    ...
    if (e.row.data.approvalStatusId == "7" && manageAllowed == "1") {
      ...
      e.row.data.approvalStatusId == "13"
    ) {
      return !e.row.isEditing;
    } else {
      return e.row.isEditing;
  ...
  editViaible(e) {
    ...
    if (Insert_Allow == "1") {
      if (
        e.row.data.approvalStatusId == "1" ||
        e.row.data.approvalStatusId == "4" ||
        e.row.data.approvalStatusId == "2" ||
        e.row.data.approvalStatusId == "7" ||
        e.row.data.approvalStatusId == "8" ||
        e.row.data.approvalStatusId == "9" ||
        e.row.data.approvalStatusId == "10"
      ) {
        return e.row.isEditing;
      } else {
        return !e.row.isEditing;
    ...
    abp.message.confirm(
      ...
      (result: boolean) => {
        if (result) {
          debugger;
          this._DashboardService
            .windowperiod(windowperiodModel)
            .subscribe((data) => {
              debugger;
