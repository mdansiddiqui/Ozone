...
{
    public partial class RequestOfSite
    {
        public RequestOfSite()
        {
        ...
        [InverseProperty(nameof(SecUser.RequestOfSiteCreatedBy))]
        public virtual SecUser CreatedBy { get; set; }
        [ForeignKey(nameof(LastModifiedById))]
        [InverseProperty(nameof(SecUser.RequestOfSiteLastModifiedBy))]
        public virtual SecUser LastModifiedBy { get; set; }
        [InverseProperty("RequestOfSite")]
