...
{
    public partial class Ozone_8_12_2023Context : DbContext
    {
        public Ozone_8_12_2023Context()
        {
        }

        public Ozone_8_12_2023Context(DbContextOptions<Ozone_8_12_2023Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-PE36NEL;Initial Catalog=Ozone_8_12_2023;user id=sa;password=123qwe;integrated security=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SecUser>(entity =>
            {
                entity.HasOne(d => d.ApprovelStatus)
                    ...
                    .HasConstraintName("FK__SecUser__Approve__46486B8E");
